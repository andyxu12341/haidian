...
On provisional geometry, the conceptual green-layer ratio is 31.5058% and six timetable public spaces represent about 1.4959%; neither is an approved statutory ratio [metric:green_ratio] [metric:public_space_ratio]. The cultural narrative is **spatial rights + temporal rights**. Railway time axes, station points, meet/pass and recovery logic become signage, paving, public information and event language [standard:MOHURD-URBAN-DESIGN-MEASURES].

## Renewal Projects, Implementation Policy, and Phasing

**Near term:** run the proposed AI Origin × Phase I P0 baseline and P1 reversible pilot; establish the TimeSlot Contract, public Time Rights display, T0 checks and no-app navigation [assumption:A-PILOT-001]. **Mid term:** replace proof assumptions with verified field data after official geometry arrives. **Long term:** only after traffic, safety, planning, utilities, heritage, ownership and operating permissions are clear should higher-level embodied-AI public operation be considered [assumption:A-ROBOTICS-001].
...
Official polygons remain missing [assumption:A-BOUNDARY-001]. Statutory controls are not invented [assumption:A-CONTROLS-001]. The AI Origin pilot is proposed, not authorized or run [assumption:A-PILOT-001]. Robotics testing is not deployment permission [assumption:A-ROBOTICS-001]. Scenario-model outputs are not observed performance [assumption:A-TEMPORAL-MODEL-001]. Essential services do not depend on facial recognition, persistent tracking or a mandatory app. Core figures/models are original or programmatically generated; see `report/copyright_statement.md`.
